...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    public NumberViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        //viewHolder.itemView.setText("viewHolderIndex is" + viewHolderCount);
        viewHolder.ViewHolderIndex.setText("viewHolderIndex is:" + viewHolderCount);
        Log.d(TAG,"the error is " + viewHolder);
        ...
        viewHolderCount++;
        Log.d(TAG,"onCreateViewholder : number of views created " + viewHolderCount);
